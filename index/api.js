...
function get_banner() {
	...
	for (var i = 1; i < data.data.length; i++) {
		src +=
			...
			"<img src='../static/images/blank.png' data-src='" + domainName + data.data[i].picurl + "' data-thumb='" +
	...
	let bannersrc =
		...
		"<img src='" + domainName + data.data[0].picurl + "'  data-thumb='" + domainName + data.data[0].picurl + "'/>" +
		" </li>" + src;
